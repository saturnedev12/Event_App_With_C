/**
 * \file on_users_menu_selected.c
 * \fn on_users_menu_selected(GtkMenuItem *item, gpointer user_data)
...
void on_users_menu_selected(GtkMenuItem *item, gpointer user_data)
{
    ...
    gtk_tree_view_insert_column_with_attributes(GTK_TREE_VIEW(treeview), -1, "NOMS", renderer, "text", 1, NULL);
